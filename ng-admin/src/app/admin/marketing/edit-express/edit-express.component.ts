...
@Component({
    ...
    templateUrl: './edit-express.component.html'
})
export class EditExpressComponent extends AppComponentBase implements OnInit {
    ...
    ngOnInit(): void {
        this.form = this.fb.group({
            expressCompany: [null, [Validators.required, Validators.maxLength(200)]],
            expressNo: [null, [Validators.required, Validators.maxLength(200)]],

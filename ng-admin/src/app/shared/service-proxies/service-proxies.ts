...
export class DriverServiceProxy {
        ...
        return this.http.request(url_, options_).flatMap((response_) => {
            ...
            if (response_ instanceof Response) {
                try {
                    ...
                    return <Observable<PagedResultDtoOfDriver>><any>Observable.throw(e);
                }
            } else
                return <Observable<PagedResultDtoOfDriver>><any>Observable.throw(response_);
        });
    }
    ...
    protected processGetAll(response: Response): Observable<PagedResultDtoOfDriver> {
        ...
        return Observable.of<PagedResultDtoOfDriver>(<any>null);
    }
}
export class PagedResultDtoOfDriver implements IPagedResultDtoOfDriver {
    totalCount: number;
    items: Driver[];

    constructor(data?: IPagedResultDtoOfDriver) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): PagedResultDtoOfDriver {
        let result = new PagedResultDtoOfDriver();
        result.init(data);
        return result;
    }
...
export interface IPagedResultDtoOfDriver {
    totalCount: number;
    items: Driver[];
}
...
export class EmployeesServiceProxy {
    ...
    */
    ...
    ExportExcel(input:any):Observable<ApiResult> {
        let url_ = this.baseUrl + "/api/services/app/Employee/ExportEmployeesExcel";
        url_ = url_.replace(/[?&]$/, "");

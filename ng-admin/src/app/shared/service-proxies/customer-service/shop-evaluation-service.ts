...
export class ShopEvaluationServiceProxy {
    private http: Http;
        ...
        return this.http.request(url_, options_).flatMap((response_) => {
            ...
            if (response_ instanceof Response) {
                try {
                    ...
                    return <Observable<PagedResultDtoOfShopEvaluation>><any>Observable.throw(e);
                }
            } else
                return <Observable<PagedResultDtoOfShopEvaluation>><any>Observable.throw(response_);
        });
    }

    protected processGetAll(response: Response): Observable<PagedResultDtoOfShopEvaluation> {
        ...
        if (status === 200) {
            ...
            result200 = resultData200 ? PagedResultDtoOfShopEvaluation.fromJS(resultData200) : new PagedResultDtoOfShopEvaluation();
        ...
        return Observable.of<PagedResultDtoOfShopEvaluation>(<any>null);
    }
}
...
export class PagedResultDtoOfShopEvaluation implements IPagedResultDtoOfShopEvaluation {
    ...
    static fromJS(data: any): PagedResultDtoOfShopEvaluation {
        let result = new PagedResultDtoOfShopEvaluation();
        result.init(data);
        return result;
    }

(function (global, factory) {
	...
	(factory((global.zef = global.zef || {}, global.zef.ngxColorPicker = {}),global.ng.core,global.ng.common));
...
var ColorPickerComponent = (function () {
    ...
    ColorPickerComponent.propDecorators = {
        "hueSlider": [{ type: core.ViewChild, args: ['hueSlider',] },],
        "alphaSlider": [{ type: core.ViewChild, args: ['alphaSlider',] },],
        "dialogElement": [{ type: core.ViewChild, args: ['dialogPopup',] },],
    };
...
var ColorPickerDirective = (function () {
    ...
    function () {
        ...
        if (!this.dialogCreated) {
            ...
            var /** @type {?} */ injector = core.ReflectiveInjector.fromResolvedProviders([], vcRef.parentInjector);
    ...
    ColorPickerDirective.propDecorators = {
        ...
        "handleFocus": [{ type: core.HostListener, args: ['focus', ['$event'],] },],

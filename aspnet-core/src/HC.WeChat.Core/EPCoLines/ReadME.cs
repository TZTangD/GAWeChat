...
```
  ...
  Configuration.Modules.AbpAutoMapper().Configurators.Add(CustomerEPCoLineMapper.CreateMappings);
```
...
```
Configuration.Authorization.Providers.Add<EPCoLineAppAuthorizationProvider>();
```
